...
function signin($registered, $banned)
{
    ...
    if (count($_POST) > 0) {
        ...
        if (!isset($_POST['email'])) die(message('error', 'please enter your email. <a href="signin.php">click here<a/>'));
        if (!isset($_POST['password'])) die(message('error', 'please enter your password. <a href="signin.php">click here<a/>'));
        ...
        while (!feof($h)) {
            ...
            if ($line[0] == $_POST['email']) {
                ...
                if (!password_verify($_POST['password'], $line[1])) {
                    ...
                    die(message('error', 'The password entered was incorrect. <a href="signin.php">click here<a/>'));
                }
                else {
                ...
                die(message('error', 'The user is not registered. <a href="signup.php">click here<a/>'));
            }
        }
        fclose($h);
